...
class hierarchical_predecode3x8(hierarchical_predecode):
    ...
    def create_layout(self):
        ...
        connections=[["A[0]",    "A[1]",    "A[2]",    "Z[7]", "vdd", "gnd"],
                     ["A[0]",    "A[1]",    "Abar[2]", "Z[6]", "vdd", "gnd"],
                     ["A[0]",    "Abar[1]", "A[2]",    "Z[5]", "vdd", "gnd"],
                     ["A[0]",    "Abar[1]", "Abar[2]", "Z[4]", "vdd", "gnd"],
                     ["Abar[0]", "A[1]",    "A[2]",    "Z[3]", "vdd", "gnd"],
                     ["Abar[0]", "A[1]",    "Abar[2]", "Z[2]", "vdd", "gnd"],
                     ["Abar[0]", "Abar[1]", "A[2]",    "Z[1]", "vdd", "gnd"],
                     ["Abar[0]", "Abar[1]", "Abar[2]", "Z[0]", "vdd", "gnd"]]

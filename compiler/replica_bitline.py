...
class replica_bitline(design.design):
    ...
    def calculate_module_offsets(self):
        ...
        self.bitcell_offset = self.rbl_inv_offset + vector(3*self.m2_pitch+drc["metal2_to_metal2"], 0) + vector(0, self.bitcell.height)
    ...
    def route_access_tx(self):
        ...
        delay_en_pin = self.dc_inst.get_pin("out")
        delay_en_offset = delay_en_pin.bc()
        ...
        mid1 = vector(vdd_pins[0].cx()+self.m2_pitch,drain_offset.y)
    ...
    def route_vdd(self):
        ...
        inv_vdd_offset = self.rbl_inv_inst.get_pin("vdd").ll() - self.offset_fix
        self.add_layout_pin(text="vdd",
                            layer="metal2",
